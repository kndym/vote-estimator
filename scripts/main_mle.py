...
Examples:
  ...
  python scripts/main_mle.py <main_data_csv> <graph_file> --output output/results.csv
        """
    )
    parser.add_argument(
        "main_data_csv",
    ...
    print("  python scripts/graph.py <shapefile> --graph_out output/blockgroups_graph.gpickle")
    print("=" * 70)
